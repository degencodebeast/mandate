...
def test_three_failures_open_the_breaker() -> None:
    ...
    for _ in range(2):
        breaker.record_failure(service_url=_SERVICE, owner="worker-1", trial_epoch=0)
    breaker.record_failure(service_url=_SERVICE, owner="worker-1", trial_epoch=0)
...
def test_success_resets_failure_count_and_closes() -> None:
    ...
    breaker.record_success(service_url=_SERVICE, owner="worker-1", trial_epoch=0)
...
def test_half_open_trial_success_closes_the_breaker() -> None:
    ...
    breaker.record_success(service_url=_SERVICE, owner="worker-1", trial_epoch=1)
...
def test_half_open_trial_failure_reopens_the_breaker() -> None:
    ...
    breaker.record_failure(service_url=_SERVICE, owner="worker-1", trial_epoch=1)
